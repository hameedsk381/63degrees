  ...
  return (
    <div className="bg-brand-linen min-h-screen text-brand-text overflow-x-clip">
      ...
      <section className="relative pt-44 pb-20 overflow-hidden bg-brand-linen">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.04]" style={{backgroundImage:`url(${images.ambiance[4]})`}} />
      ...
      <section className="py-16 bg-brand-linen/40 border-y border-brand-burgundy/10 relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.03]" style={{backgroundImage:`url(${images.ambiance[1]})`}} />
      ...
      <section className="py-16 bg-brand-dark relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.06]" style={{backgroundImage:`url(${images.ambiance[3]})`}} />
      ...
      <section className="py-16 bg-brand-linen border-y border-brand-burgundy/10 relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.04]" style={{backgroundImage:`url(${images.ambiance[5]})`}} />
      ...
      <section className="py-24 relative bg-brand-linen overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-[0.04]" style={{backgroundImage:`url(${images.ambiance[7]})`}} />
